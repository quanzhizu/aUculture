...
@interface ICZoomingScrollView ()
@property (nonatomic, assign) ICPhotoBrowser *photoBrowser;
- (void)handleSingleTap:(CGPoint)touchPoint;
- (void)handleDoubleTap:(CGPoint)touchPoint;
@end

@implementation ICZoomingScrollView
...
- (id)initWithPhotoBrowser:(ICPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		// 点击背景的视图
		_tapView = [[ICTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[ICTapDetectingImageView alloc] initWithFrame:CGRectZero];
...
- (void)setPhoto:(id<ICPhoto>)photo {
...
#pragma mark - MWTapDetectingImageViewDelegate methods
...
#pragma mark - MWTapDetectingViewDelegate methods
